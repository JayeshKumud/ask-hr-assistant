create Gemini account and add models
implement litellm LLM gateway
correct project, directory and remote repo name
add tech stack being used
add unit tests
update all documents
check eks kubernetes video and implement
MCP server


make repo on each like deepevals, litellm etc
